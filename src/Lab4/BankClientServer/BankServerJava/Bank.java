package Lab4.BankClientServer.BankServerJava;
...
public class Bank {
    ...
    public int createAccount(int customerId){
        ...
        synchronized (accounts) {
            for (Map.Entry<Integer, Account>
                    entry : accounts.entrySet())
                accountNumber = Math.max(accountNumber, entry.getValue().getAccountNumber()) + 1;

            createAccount(customerId, accountNumber, 0);
        }
